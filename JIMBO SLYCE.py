...
def initialForm(n,k,canvas, data):
    ...
    canvas.create_text(data.width / 20 + 3, data.height / 20 * (r + 4) + 3, anchor = NW, text = "Pick m + n total people from a group of k objects" , width = data.width / 8, font = "helvetica " + str(s), justify = CENTER)
