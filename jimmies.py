...
def initialForm(m,n,k,canvas, data):
    ...
    canvas.create_text(data.width / 20 + 3, data.height / 20 * (r + 4) + 3, anchor = NW, text = "Pick k total buttholes from a group of m + n objects" , width = data.width / 8, font = "helvetica " + str(s), justify = CENTER)
