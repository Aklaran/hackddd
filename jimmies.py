...
def initialForm(m,n,k,canvas, data):
    ...
    canvas.create_text(data.width / 10 * 7/4, data.height/20 * (r + 1) * .9, text = str(n), font = "helvetica " + str(int(1.5 * s )))
    canvas.create_text(data.width / 10 * 7/4, data.height/20 * (r + 1) * 1.25, text = "i", font = "helvetica " + str(int(1.5 * s)))
    canvas.create_text(data.width / 10 * 2.8, data.height/20 * (r + 1) * .9, text = str(m), font = "helvetica " + str(int(1.3 * s )))
